 ...
 */
public final class DiploBNAdjudicator
        implements Adjudicator {


    public static final int ADJUDICATION_MODE = 3;
    // 1 = JUDGE
    // 2 = JUSTICE
    // 3 = SZYKMAN_JUSTICE
    ...
    public void judge() {
        ...
        switch (ADJUDICATION_MODE) {
            case 1 -> judge = new Judge(workOrders);
            case 2 -> judge = new Justice(workOrders);
            case 3 -> judge = new SzykmanJustice(workOrders);
            default -> judge = new Judge(workOrders);
        }
